...
export default class testsHelper {
  ...
  eventownervalid = new this.eventOwner("amit", "0546343178");

  suppliervalid = new this.Supplier("reut", "0546343178", "flowers", "1000");
  ...
  eventownernotvalid = new this.eventOwner("amit", "");

  suppliernotvalid = new this.Supplier("reut", "", "flowers", "1000");
